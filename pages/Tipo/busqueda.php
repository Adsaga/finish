		...
		<center>
			<h1>Busqueda Tipo de medicmentos</h1>
		  <p>CRITERIOS:
	    ...
	    <table width="610px" border="0" align="center">
          <tr>
            <td>
				...
				<tr><td ><h4>Numeracion</h4></td><td ><h4>Tipo</h4>
				</tr>
				</thead>
				<?php
			    ...
			    if ($buscar1!="" or $criterios=='Todos'  ) {
					   ...
					   if ($criterios=='Todos') {
						...
						//if (mysql_num_rows($result1)>=1) {
							...
							{
								echo '<tr><td data-label="Curp"><a href="modificaclientes.php?aplicar5='.$row["Id_Tipo"].'">'.$row["Id_Tipo"].'</a></td>
								<td data-label="Nombre">'.$row["Nombre_Tipo"].'</td>
