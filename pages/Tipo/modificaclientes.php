...
<form name="form5" action="datos.php" method="POST" enctype="multipart/form-data">
			  <?php
				...
				$result1=mysql_query("select * from tipo where Id_Tipo='$aplicar5'",$conexion); 
				if (mysql_num_rows($result1)>=1) {
					while ($row=mysql_fetch_array($result1))
					{
                        $aplicar5=$row['Id_Tipo'];
						$nombre5=$row['Nombre_Tipo'];
					}?>
					<table cols="3" border="0" align="center">
					<tr align="center"><td colspan="3"><H1>Actualizar Tipo de medicamentos</H1></td></tr>
					...
					<tr align="right"><td>Tipo :</td><td align="left"><input type="text" maxlength="30" name="nombre5" value="<?php echo $nombre5;?>"/></td>
					</tr>
