...
<form name="form1" action="datos.php" method="post" enctype="multipart/form-data">
			<table cols="2" border="0" align="center">
				<tr align="center"><td colspan="2"><H1>Registrar Laboratorio</H1></td></tr>
				<tr align="right"><td>Nombre :</td><td align="left"><input name="aplicar" type="text" value="<?php if (isset($aplicar))echo $aplicar; ?>" maxlength="18" required/></td></tr>
