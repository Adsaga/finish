<?php
	...
	if(!$conexion)
	{
		...
		if ($ncapa==3){//CAPA 3 PARA GUARDAR DATOS
			echo "<script>location.href='formularios.php'</script>";
			 $aplicar=$_REQUEST['aplicar']; 
				...
				$variable1="insert into unidadmedida"; 
				$campos=" (Nombre_UnidadMedida)";
		...
		if ($ncapa==5 && $g==1){//CAPA 5 PARA ACTUALIZAR DATOS
			...
			$variable1="update unidadmedida set "; 
			 echo $campos="Nombre_UnidadMedida='$nombre5'";
			$criterio=" where Id_UnidadMedida='$Id'";
