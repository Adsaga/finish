...
<form name="form5" action="datos.php" method="POST" enctype="multipart/form-data">
           ...
           <tr align="right"><td>Clave:</td><td align="left"><input name="clave5" type="text" value="<?php if (isset($clave5))echo $clave5; ?>" maxlength="10"/></td></tr>
            <tr align="right"><td>lote:</td><td align="left"><input name="lote5" type="text" value="<?php if (isset($lote5))echo $lote5; ?>" maxlength="10"/></td></tr>
