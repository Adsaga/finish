...
<form name="form5" action="datos.php" method="POST" enctype="multipart/form-data">
			  <?php
				...
				$result1=mysql_query("select * from especialidadmedico where Id_Especialidad='$aplicar5'",$conexion); 
				if (mysql_num_rows($result1)>=1) {
					...
					<tr align="right"><td>Modo de uso:</td><td align="left"><input type="text" maxlength="30" name="nombre5" value="<?php echo $nombre5;?>"/></td>
					</tr>
