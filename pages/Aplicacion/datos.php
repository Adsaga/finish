<?php
	...
	if(!$conexion)
	{
		...
		if ($ncapa==3){//CAPA 3 PARA GUARDAR DATOS
			echo "<script>location.href='formularios.php'</script>";
			 $aplicar=$_REQUEST['aplicar']; 
				...
				$variable1="insert into aplicacion"; 
				$campos=" (Nombre_Aplicacion)";
		...
		if ($ncapa==5 && $g==1){//CAPA 5 PARA ACTUALIZAR DATOS
			...
			$variable1="update aplicacion set "; 
			 echo $campos="Nombre_Aplicacion='$nombre5'";
			$criterio=" where Id_Aplicacion='$Id'";
