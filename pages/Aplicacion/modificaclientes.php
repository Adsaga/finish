...
<form name="form5" action="datos.php" method="POST" enctype="multipart/form-data">
			  <?php
				...
				$result1=mysql_query("select * from aplicacion where Id_Aplicacion='$aplicar5'",$conexion); 
				if (mysql_num_rows($result1)>=1) {
					while ($row=mysql_fetch_array($result1))
					{
                        $aplicar5=$row['Id_Aplicacion'];
						$nombre5=$row["Nombre_Aplicacion"];
					}?>
					<table cols="3" border="0" align="center">
					<tr align="center"><td colspan="3"><H1>Actualizar modo de aplicacion</H1></td></tr>
					...
					<tr align="right"><td>Modo de uso:</td><td align="left"><input type="text" id="modo" maxlength="30" name="nombre5" value="<?php echo $nombre5;?>"  /></td>
					</tr>
