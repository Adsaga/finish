		...
		if ($ncapa==3){//CAPA 3 PARA GUARDAR DATOS
			...
			$med=$_REQUEST['med']; 
			 ...
			 $cajas=$_REQUEST['cajas']; 
               ...
               $query= mysql_query("SELECT MAX(Id_Citas) AS cita FROM citas");
             if ($row = mysql_fetch_row($query)) 
            {
              $cita = trim($row[0]);
				...
				$variable1="insert into detallesmedicamentos"; 
				$campos=" (Id_ClaveR,Id_CitasR,Modo_Aplicacion,canAsignada)";
				 $valores=" values('$med',$cita,'$aplica',$cajas)";
