...
<div id="pagewrap">
	...
	<div id="content">
		<article class="post clearfix">
			<header>
				<h1 class="post-title"><a href="#">Medico<hr></a></h1>
				Opciones...
			</header>
			<figure class="post-image"> 
		...
		<div class="ventana">
			<div class="form">
				...
				<iframe name="zona1" width="100%" height="90%" src="Medico/formularios.php"></iframe>
			</div>
		</div>
		<div class="ventana1">
			<div class="form">
				<div class="cerrar"><a href="javascript:cerrar1();">Cerrar X</a></div>
				<iframe name="zona1" width="100%" height="90%" src="Medico/busqueda.php"></iframe>
			</div>
		</div>
	</div>
	<!-- /#content --> 	
