	...
	if(!$conexion)
	{
		...
		if ($ncapa==3){//CAPA 3 PARA GUARDAR DATOS
			...
			$direccion=$_REQUEST['direccion'];
				...
				$variable1="insert into enfermera"; 
				$campos=" (CedulaProfecional,Nombre_Enfermera,Apellido_P,Apellido_M,Edad,Sexo,IdTipo_SangreR,Id_EspecialidadR,Direccion)";
				echo $valores=" values('$cedProf','$nombre','$apellidoP','$apellidoM',$edad,'$sexo',$sangre,$espec,'$direccion')";
		...
		if ($ncapa==5 && $g==1){//CAPA 5 PARA ACTUALIZAR DATOS
			...
			$variable1="update enfermera set "; 
			echo $campos="CedulaProfecional='$cedProf5',Nombre_Enfermera='$nombre5',Apellido_P='$apellidoP5',Apellido_M='$apellidoM5',Sexo='$sexo5',Edad=$edad5,IdTipo_SangreR=$sangre5,Id_EspecialidadR=$espec5,Direccion='$direccion5'";
			$criterio=" where CedulaProfecional='$cedProf5'";
		...
		if ($ncapa==5 && $b==1){//CAPA 5 PARA ELIMINAR DATOS
			$cedProf5=$_REQUEST['cedProf5']; 
			$variable="delete from Enfermera  where cedProf='$cedProf5'"; 
