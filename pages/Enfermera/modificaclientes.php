...
<form name="form5" action="datos.php" method="POST" enctype="multipart/form-data">
			  <?php
				...
				$result1=mysql_query("select a.CedulaProfecional,a.Nombre_Enfermera,a.Apellido_P,a.Apellido_M,a.Sexo,a.Edad,b.TipoSangre,a.Direccion,c.Nombre_Especialidad from enfermera a
                           ...
                           where  CedulaProfecional='$cedProf5'",$conexion); 
				if (mysql_num_rows($result1)>=1) {
					while ($row=mysql_fetch_array($result1))
					{
						$cedProf5=$row["CedulaProfecional"];$nombre5=$row["Nombre_Enfermera"];$apellidoP5=$row["Apellido_P"];$apellidoM5=$row["Apellido_M"];
					...
					<tr align="center"><td colspan="3"><H1>Modificacion de Enfermera</H1></td></tr>
 ...
 <tr align="right"><td>Direccion :</td><td align="left"><input name="direccion5" type="text" value="<?php if (isset($direccion5)) echo $direccion5; ?>" maxlength="200"/></td></tr>
					...
					<input type="hidden" name="cedProf5" value="<?php echo $cedProf5;?>" />
