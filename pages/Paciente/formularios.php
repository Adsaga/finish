...
<form name="form1" action="datos.php" method="post" enctype="multipart/form-data">
			<table cols="2" border="0" align="center">
				...
				<tr align="right"><td>Curp:</td><td align="left"><input name="curp" type="text" value="<?php if (isset($curp))echo $curp; ?>" maxlength="18" title="Ejemplo: PFTY901714HOCTRP03" pattern="[A-Z]{4}[0-9]{6}[A-Z]{6}[0-9]{2}" required/></td></tr>
				...
				<tr align="right"><td>Apellido Paterno:</td><td align="left"><input name="apellidoP" type="text" value="<?php if (isset($apellidoP))echo $apellidoP; ?>" maxlength="30" title="Solo texto" pattern="[A-Za-z ]*" required/></td></tr>
				<tr align="right"><td>Apellido Materno:</td><td align="left"><input name="apellidoM" type="text" value="<?php if (isset($apellidoM))echo $apellidoM; ?>" maxlength="30" title="Solo texto" pattern="[A-Za-z ]*" required/></td></tr>
