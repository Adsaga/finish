...
<fieldset>
<legend class="legend"><center>Registrar Encargado</center></legend>
<div class="input">
Curp: <input type="text" placeholder="Cedula profesional" required name="cedprof" value="<?php if (isset($cedprof))echo $cedprof; ?>" ></div>
<div class="input">
